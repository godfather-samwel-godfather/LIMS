<?php
// Create a test security officer user
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        echo "<a href='../front/test_security_login.php'>← Back to Test</a>";
    } else {
        // Insert new security officer user
        $stmt = $conn->prepare("INSERT INTO users (First_Name, Last_Name, Email, Password, Role) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssss", $firstName, $lastName, $email, $hashedPassword, $role);

        if ($stmt->execute()) {
            echo "<h2>✅ Security Officer User Created Successfully!</h2>";
            ...
            echo "<p><a href='../front/test_security_login.php'>← Back to Test Page</a></p>";
        } else {
    ...
    header("Location: ../front/test_security_login.php");
    exit();
}
?>
